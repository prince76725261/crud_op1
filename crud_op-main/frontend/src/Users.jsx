...
function Users() {
    ...
    return (
        <div className='d-flex vh-100 bg-secondary justify-content-center align-items-center content-flex'>
               ...
               {/* <Link to="/create" className='btn btn-success'>Add_User +</Link> */}
                ...
                <table className='table'>
                    ...
                    ShowModal && <MyModal closeModal={closeModal} />
                                        ...
                                        {/* <button className='btn btn-success' onClick={(e) => setShowModal(true)}>Update User</button>{
                                        ShowModal2 && < MyModal2 key={user._id} closeModal={closeModal} />} */}
